...
(function (TontoDirectiveRenderer) {
	...
	/**
	 * Determines if a directive is block or solo, then returns a valid rendered apache config string.
	 * @method render
	 * @static
	 * @public
	 * @param  {TontoDirective} directive TontoDirective to be rendered.
	 * @return {string} Valid rendered apache config string representation of the supplied TontoDirective.
	 */
